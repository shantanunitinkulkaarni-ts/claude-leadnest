...
export const FAQS: FaqGroup[] = [
  {
    ...
    items: [
      { q: 'What is TING?', a: 'TING is an AI WhatsApp assistant built for Indian real-estate agents. It connects to your WhatsApp number and automatically replies to leads, answers their questions, qualifies them, shares property details, and books site visits — 24/7, in multiple Indian languages.' },
      { q: 'How does the AI assistant work?', a: 'When a lead messages your WhatsApp, TING reads the message and replies instantly using your property details, areas and tone. It nurtures the lead through the conversation and notifies you when someone is ready to talk or book a visit. You stay in control and can jump into any chat yourself from the Inbox.' },
      ...
      { q: 'What languages does the bot support?', a: 'TING handles English, Hindi, Marathi, Gujarati and more — it replies in the language your lead writes in, so conversations feel natural.' },
    ],
  },
  {
    section: 'Billing & plans',
    items: [
      { q: 'How much does TING cost?', a: 'TING is ₹999 per month. It auto-renews monthly via UPI Autopay, and you can cancel anytime — you keep access until the end of the period you have already paid for.' },
      ...
      { q: 'Where can I find my invoices / receipts?', a: 'On the Balance screen, scroll to "Billing history". Every payment is listed there with a "Receipt" button — open it and use your browser\'s Print → Save as PDF to download a copy. Note: TING is operated by Convorian, which is currently a sole proprietorship and is not GST-registered, so these are payment receipts, not tax invoices.' },
