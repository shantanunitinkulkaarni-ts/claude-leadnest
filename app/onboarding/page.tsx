          ...
          {currentStep === 3 && (
            <div className="whatsapp-connect">
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: 14, marginBottom: 20, paddingBottom: 20, borderBottom: '1px solid var(--border)' }}>
                ...
                <div>
                  <div style={{ fontSize: 15, fontWeight: 500, color: 'var(--ink)', marginBottom: 3 }}>Connect your WhatsApp number</div>
                  <div style={{ fontSize: 12, color: 'var(--ink-3)', lineHeight: 1.5 }}>Your existing WhatsApp Business number connects in minutes.</div>
                </div>
              </div>
              <div className="wa-number-display">
                ...
                <span className={`wa-status ${waStatus === 'Connected' ? 'connected' : ''}`}>{waStatus}</span>
              </div>
