...
- Application and data are hosted on managed cloud infrastructure (AWS and Supabase)
...
- **Groq:** To power AI conversation responses (Llama models)
- **Razorpay:** To process payments
- **Resend:** To send transactional emails
- **Amazon Web Services (AWS):** Our hosting infrastructure
...
To exercise any of these rights, email: privacy@convorian.in
